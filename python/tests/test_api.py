...
class TestMusicnotegeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = MusicnotegeneratorAPIClient(self.api_key)

    @patch('apiverve_musicnotegenerator.apiClient.requests.get')
