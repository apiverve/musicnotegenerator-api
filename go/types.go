// Package musicnotegenerator provides a Go client for the Music Note Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/musicnotegenerator?utm_source=go&utm_medium=readme
package musicnotegenerator
...
// Request contains the parameters for the Music Note Generator API.
//
// Parameters:
//   - note (required): string - Musical note (A-G with optional # or b)
//   - octave: integer - Octave number [min: 0, max: 8]
//   - duration: number - Duration in seconds [min: 0.1, max: 10]
type Request struct {
	Note string `json:"note"` // Required
	Octave int `json:"octave,omitempty"` // Optional
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"octave": {Type: "integer", Required: false, Min: float64Ptr(0), Max: float64Ptr(8)},
		"duration": {Type: "number", Required: false, Min: float64Ptr(0.1), Max: float64Ptr(10)},
	}
...
// ResponseData contains the data returned by the Music Note Generator API.
...
// AudioData represents the audio object.
