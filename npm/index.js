...
class musicnotegeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/musicnotegenerator');
        }
        ...
        this.validationRules = {"note":{"type":"string","required":true},"octave":{"type":"integer","required":false,"min":0,"max":8,"default":4},"duration":{"type":"number","required":false,"min":0.1,"max":10,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/musicnotegenerator`);
        }
    }
...
module.exports = musicnotegeneratorWrapper;
