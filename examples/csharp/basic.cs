...
{
    class MusicNoteGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/musicnotegenerator";

        /// <summary>
        /// Make a GET request to the Music Note Generator API
        /// </summary>
        static async Task<JsonDocument> CallMusicNoteGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;note&quot;] &#x3D; &quot;C&quot;, [&quot;octave&quot;] &#x3D; 4, [&quot;duration&quot;] &#x3D; 1.0 };
        ...
        {
            Console.WriteLine("📤 Calling Music Note Generator API...\n");

            var result = await CallMusicNoteGeneratorAPI();
