...
namespace APIVerve.API.MusicNoteGenerator
{
    ...
    /// <summary>
    /// Client for the MusicNoteGenerator API
    /// </summary>
    public class MusicNoteGeneratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/musicnotegenerator";
        ...
        {
            { "note", new ValidationRule { Type = "string", Required = true } },
            { "octave", new ValidationRule { Type = "integer", Required = false, Min = 0, Max = 8 } },
            { "duration", new ValidationRule { Type = "number", Required = false, Min = 0.1, Max = 10 } }
        };
        ...
        public MusicNoteGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MusicNoteGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MusicNoteGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MusicNoteGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MusicNoteGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(MusicNoteGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MusicNoteGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MusicNoteGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MusicNoteGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MusicNoteGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MusicNoteGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MusicNoteGeneratorQueryOptions options)
        {
